...
*/
    ...
    // creare tabella token con unico campo riportante il token (scritto solo al momento del logout)
    // verificare presenza token in tabella e riportarne il boolean nel metodo qui sopra.
